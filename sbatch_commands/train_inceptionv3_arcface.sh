...
# A name for the job
#SBATCH --job-name=train_inceptionV3_arcface
...
#SBATCH -e sbatch_logs/inceptionv3_arcface_errors_log.txt
#SBATCH -o sbatch_logs/inceptionv3_arcface_output_log.txt
...
python src/trainer.py --config configs/inceptionv3_Arcface.yaml